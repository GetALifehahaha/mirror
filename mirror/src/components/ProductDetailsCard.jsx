...
const SimpleProductDetails = ({productDetails}) => {
    return (
        <div className='font-medium text-text/50 flex flex-col gap-2 shadow-sm p-2 rounded-sm'>
            <span className='flex gap-1 text-lg'>Name: <h3 className='text-text font-semibold'>{productDetails.productName}</h3></span>
